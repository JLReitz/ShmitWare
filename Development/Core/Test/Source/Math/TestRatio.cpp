...
::testing::AssertionResult AssertRuntimeIntegerDivision()
{
    ...
    if (check_quotient != 0)
    {
        intmax_t check_result_int = Value / check_quotient;
        intmax_t result_int       = Value / test_ratio;
        if (result_int != check_result_int)
        {
            return ::testing::AssertionFailure()
...
TEST(Ratio, Infinity_Calculation)
{
...
TEST(Ratio, Not_A_Number_Calculation)
{
